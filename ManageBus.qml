...
Page {
    ...
    header: ToolBar {
        ...
        Button {
            ...
            id: managebusbtn
            onClicked: {
                loader.source = "AddBusForm.qml"
            }

            contentItem: Text {
                text: managebusbtn.text
                font.pointSize: 13
                opacity: enabled ? 1.0 : 0.3
                color: managebusbtn.down ? "#090707" : "#ffffff"
            ...
            background: Rectangle {
                ...
                border.color: managebusbtn.down ? "#17a81a" : "#3a64f9"
                border.width: 1
                radius: 6
            }
        }
        ...
        Row {
            ...
            TextField {
                ...
                onAccepted: {
                    ...
                    var model = "select * from bus where busmatricule='%1'".arg(text)
            ...
            Image {
                ...
                onClicked: {
                    ...
                    sqlmodel.query = "select * from bus"; // Example query for refreshing data
                }
                }
            }
        }
